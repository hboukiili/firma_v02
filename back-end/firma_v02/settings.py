"""
Django settings for firma_v02 project.
...
SECRET_KEY = 'django-insecure-=0t^js==kzcr5(260=kcyg*8j$2rr&dx3$(fcq-!8ugt606lj^'
...
MIDDLEWARE = [
    ...
    # 'rest_framework_simplejwt.middleware.TokenErrorMiddleware',
]
...
WSGI_APPLICATION = 'firma_v02.wsgi.application'
