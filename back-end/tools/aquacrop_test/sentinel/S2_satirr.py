...
def S2_download(lat,lon,level):
	...
	#start_date="2016-12-06"+"T00:00:00.000Z"	# date du changement de format de distribution
	#end_date="NOW"	
		...
		for prod in products:
			...
			if date_prod>=start_date:	
				...
				if cloud < 75:
					...
					test_zip=zipped_file_exists is False or part_file_exists is True
