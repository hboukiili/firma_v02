...
def SEBALcode(number,inputExcel):
    ...
    # input_folder = '/tools/PySEBAL_dev/test_data/input/insat'
    # print("-0-0-0-0---0-0-0-", input_folder)
    output_folder = r"%s" %str(ws['C%d' %number].value)
    # output_folder = '/tools/PySEBAL_dev/test_data/output/'
    ...
    # DEM_fileName = '/tools/PySEBAL_dev/test_data/input/dem_dal.tif'
...
def info_general_metadata(filename):
    ...
    """
    print('here : ', filename)
    # filename = '/tools/PySEBAL_dev/test_data/input/insat/LC08_L1TP_173049_20140310_20170425_01_T1_B5.TIF'
