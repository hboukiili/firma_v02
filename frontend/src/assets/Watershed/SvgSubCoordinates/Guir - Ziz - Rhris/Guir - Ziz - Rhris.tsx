import ZizRheris from "./Ziz-Rheris"
import GuirBouanane from "./Guir - Bouanane"
...
const GuirZizRhris = () => {
    ...
    return (
        <div className="flex">
            ...
            <svg className="w-[45%] min-w-[360px] relative" viewBox="0 0 331 209" xmlns="http://www.w3.org/2000/svg">
                <path
                    {...pathObj("Guir - Bouanane")}
                    d={GuirBouanane}
                />
                <path
                    {...pathObj("Ziz - Rheris")}
                    d={ZizRheris} stroke="#EAF3E9" stroke-width="0.98"
                />
            </svg>
        </div>
    )
