import Zouzfana from "./Zouzfana (unité de Figuig)"
import Isly from "./Isly"
import Nador from "./Nador (Kert)"
import Moulouya_ from "./Moulouya_"
...
const Moulouya = () => {
    ...
    return (
        <div className="flex">
            ...
            <svg className="w-[45%] min-w-[360px] relative" viewBox="0 0 331 258" xmlns="http://www.w3.org/2000/svg">
                <path
                    {...pathObj("Zouzfana (unité de Figuig)")}
                    d={Zouzfana}
                />
                <path
                    {...pathObj("Isly")}
                ...
                <path
                    {...pathObj("Moulouya")}
                    d={Moulouya_} stroke="#EAF3E9" stroke-width="0.98"
                />
            </svg>
