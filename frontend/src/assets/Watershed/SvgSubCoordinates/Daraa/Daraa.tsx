import HautDaraa from "./HautDaraa"
import BasDaraa from "./BasDaraa"
...
const Daraa = () => {
    ...
    return (
        <div className="flex">
            ...
            <svg className="w-[45%] min-w-[360px] relative" viewBox="0 0 331 226" xmlns="http://www.w3.org/2000/svg">
                <path
                    {...pathObj("Haut Daraa")}
                    d={HautDaraa}
                />
                <path
                    {...pathObj("Bas Daraa")}
                    d={BasDaraa} stroke="#EAF3E9" stroke-width="0.98"
                />
            </svg>
        </div>
    )
